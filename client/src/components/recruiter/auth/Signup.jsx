...
function Signup() {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const response = await axios.post('https://clone-internshub-client.vercel.app/recruiter/signup', {
        firstname,
        lastname,
        email,
        phone,
  ...
  const handleGoogleClick=async(e)=>{
    ...
    try {
      ...
      const response = await axios.post('https://clone-internshub-client.vercel.app/recruiter/signup/googleauth', {
        email,
        firstname,
        lastname,
      });
