...
function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://clone-internshub-client.vercel.app/student/login', {
        email,
        password,
      });
  ...
  const handleGoogleClick = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://clone-internshub-client.vercel.app/student/login/googleauth', {
        email,
        firstname,
        lastname
      });
