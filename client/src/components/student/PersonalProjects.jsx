...
const PersonalProjects = () => {
  ...
  useEffect(() => {
    const fetchPersonalProjects = async () => {
      try {
        const response = await axios.get(`https://clone-internshub-client.vercel.app/student/profile/${userId}/personal-projects`);
        if (!response.data) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editIndex !== null) {
        ...
        const response = await axios.put(`https://clone-internshub-client.vercel.app/student/profile/${userId}/personal-projects/${editIndex}`, projectData);
        ...
        const response = await axios.post(`https://clone-internshub-client.vercel.app/student/profile/${userId}/personal-projects`, projectData);
  ...
  const handleDelete = async (index) => {
    try {
      await axios.delete(`https://clone-internshub-client.vercel.app/student/profile/${userId}/personal-projects/${index}`);
