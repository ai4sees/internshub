...
const Education = () => {
  ...
  useEffect(() => {
    const fetchEducation = async () => {
      try {
        const response = await axios.get(`https://clone-internshub-client.vercel.app/student/profile/${userId}/education`);
        if (!response.data) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editIndex !== null) {
        ...
        const response = await axios.put(`https://clone-internshub-client.vercel.app/student/profile/${userId}/education/${editIndex}`, educationData);
        ...
        const response = await axios.post(`https://clone-internshub-client.vercel.app/student/profile/${userId}/education`, educationData);
  ...
  const handleDelete = async (index) => {
    try {
      ...
      await axios.delete(`https://clone-internshub-client.vercel.app/student/profile/${userId}/education/${index}`);
