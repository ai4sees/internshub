...
const Resume = () => {
  ...
  useEffect(() => {
    ...
    const fetchResume = async () => {
      try {
        const response = await axios.get(`https://clone-internshub-client.vercel.app/student/resume/${userId}`, {
  ...
  const handleSubmit=async(e)=>{
    ...
    try {
      await axios.post(`https://clone-internshub-client.vercel.app/student/upload-resume/${userId}`, formData, {
