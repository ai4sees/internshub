...
const WorkExp = () => {
  ...
  useEffect(() => {
    const fetchWorkExperiences = async () => {
      try {
        const response = await axios.get(`https://clone-internshub-client.vercel.app/student/profile/${userId}/work-experience`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentEditIndex !== null) {
        ...
        await axios.put(`https://clone-internshub-client.vercel.app/student/profile/${userId}/work-experience/${currentEditIndex}`, workExpData);
        ...
        // Add new experience
        const response = await axios.post(`https://clone-internshub-client.vercel.app/student/profile/${userId}/work-experience`, workExpData);
  ...
  const handleDelete = async (index) => {
    try {
      await axios.delete(`https://clone-internshub-client.vercel.app/student/profile/${userId}/work-experience/${index}`);
