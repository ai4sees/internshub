...
const Certificates = () => {
  ...
  useEffect(() => {
    const fetchCertificates = async () => {
      try {
        const response = await axios.get(`https://clone-internshub-client.vercel.app/student/profile/${userId}/certificates`);
        if (!response.data) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editIndex !== null) {
        ...
        const response = await axios.put(`https://clone-internshub-client.vercel.app/student/profile/${userId}/certificates/${editIndex}`, certificateData);
        ...
        const response = await axios.post(`https://clone-internshub-client.vercel.app/student/profile/${userId}/certificates`, certificateData);
  ...
  const handleDelete = async (index) => {
    try {
      await axios.delete(`https://clone-internshub-client.vercel.app/student/profile/${userId}/certificates/${index}`);
